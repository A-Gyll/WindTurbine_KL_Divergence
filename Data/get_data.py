...
def categorize_columns(filtered_df):
    gearbox_bins = [-np.inf, 45, 50, 55, 60, np.inf]
    gearbox_labels = ['<45', '45-50', '50-55', '55-60', '60<']
    filtered_df['gearbox_temp_bin'] = pd.cut(filtered_df['gearbox_oil_temp'], bins=gearbox_bins, labels=gearbox_labels, include_lowest=True)
    ...
    filtered_df = filtered_df.drop(columns=['pitch_angle', 'gearbox_oil_temp'])

    gearbox_counts = filtered_df['gearbox_temp_bin'].value_counts(sort=False)
...
def main():
    data_directory = "/home/ujx4ab/ondemand/data/wind_farm_a/datasets"
    output_dir = "/home/ujx4ab/ondemand/data/wind_farm_a/datasets"
    output_csv_path = "/home/ujx4ab/ondemand/WindTurbine_KL_Divergence/Data/combined_data.csv"
